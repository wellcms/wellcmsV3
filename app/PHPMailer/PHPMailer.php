...
class PHPMailer
{
     ...
     */
    public function addAddress($address, string $name = '')
    {
     ...
     * @return bool true on success, false if address already used or invalid in some way
     */
    public function addCC($address, string $name = '')
    {
     ...
     * @return bool true on success, false if address already used or invalid in some way
     */
    public function addBCC($address, string $name = '')
    {
     ...
     * @return bool true on success, false if address already used or invalid in some way
     */
    public function addReplyTo($address, string $name = '')
    {
     ...
     * @return bool true on success, false if address already used or invalid in some way
     */
    protected function addAnAddress($kind, $address, string $name = ''): bool{
     ...
     * @return array
     */
    public static function parseAddresses($addrstr, bool $useimap = true, $charset = self::CHARSET_ISO88591)
    {
        $addresses = [];
     ...
     * @return bool
     */
    public function setFrom($address, string $name = '', bool $auto = true): bool{
...
*/
    ...
    public function preSend(): bool{
        ...
        if (
            'mail' === $this->Mailer
            && ((\PHP_VERSION_ID >= 70000 && \PHP_VERSION_ID
                < 70017) || (\PHP_VERSION_ID >= 70100 && \PHP_VERSION_ID < 70103))
     ...
     * @return bool
     */
    public function setSMTPXclientAttribute($name, $value): bool{
     ...
     */
    public function setLanguage(string $langcode = 'en', string $lang_path = '')
    {
     ...
     * @return string
     */
    public function wrapText($message, $length, bool $qp_mode = false)
    {
        if ($qp_mode) {
     ...
     * @return string
     */
    public function encodeHeader($str, string $position = 'text')
    {
        $matchcount = 0;
     ...
     * @return string
     */
    public function encodeQ($str, string $position = 'text')
    {
     ...
     */
    public function clearCustomHeader($name, $value = null): bool{
     ...
     * @throws Exception
     */
    public function replaceCustomHeader($name, $value = null): bool{
        if (null === $value && strpos($name, ':') !== false) {
            //Value passed in as name:value
            list($name, $value) = explode(':', $name, 2);
        }
     ...
     */
    public function msgHTML($message, string $basedir = '', bool $advanced = false)
    {
     ...
     * @return string
     */
    public function html2text($html, bool $advanced = false)
    {
     ...
     */
    public static function _mime_types(string $ext = '')
    {
        $mimes = [
     ...
     * @return bool
     */
    public function set($name, string $value = ''): bool{
     ...
     */
    public function sign($cert_filename, $key_filename, $key_pass, string $extracerts_filename = ''): void{
