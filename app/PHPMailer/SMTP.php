...
class SMTP
{
     ...
     * @see SMTP::$do_debug
     */
    protected function edebug($str, int $level = 0): void{
     ...
     * @return bool
     */
    public function connect($host, $port = null, int $timeout = 30, array $options = []): bool{
     ...
     */
    protected function getSMTPConnection($host, $port = null, int $timeout = 30, array $options = [])
    {
        static $streamok;
     ...
     * @return bool
     */
    public function hello(string $host = '')
    {
     ...
     * @return bool
     */
    public function quit(bool $close_on_error = true)
    {
     ...
     * @return bool
     */
    public function recipient($address, string $dsn = '')
    {
        if (empty($dsn)) {
     ...
     */
    public function client_send($data, string $command = '')
    {
     ...
     * @param bool $enabled
     */
    public function setVerp(bool $enabled = false): void{
     ...
     */
    protected function setError($message, string $detail = '', string $smtp_code = '', string $smtp_code_ex = ''): void{
        $this->error = [
            'error' => $message,
            'detail' => $detail,
            'smtp_code' => $smtp_code,
     ...
     */
    public function setDebugOutput(string $method = 'echo'): void{
     ...
     */
    protected function errorHandler($errno, $errmsg, string $errfile = '', int $errline = 0): void{
